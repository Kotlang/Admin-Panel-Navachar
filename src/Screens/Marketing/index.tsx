					...
					<div className="w-[50%] flex px-4 justify-end">
						...
						<div className="flex items-center">
							<Menu>
								...
								<MenuList placeholder="" className=" bg-main_black text-slate-300">
									<MenuItem placeholder="" onClick={() => handleSelect('A')} className={`mb-1 ${filter === 'A' ? ' text-green-500' : ''}`}>All</MenuItem>
									<MenuItem placeholder="" onClick={() => handleSelect('I')} className={`mb-1 ${filter === 'I' ? ' text-green-500' : ''}`}>Installed</MenuItem>
									<MenuItem placeholder="" onClick={() => handleSelect('N')} className={`mb-1 ${filter === 'N' ? ' text-green-500' : ''}`}>Not Installed</MenuItem>
									<MenuItem placeholder="" onClick={() => handleSelect('NA')} className={`mb-1 ${filter === 'NA' ? ' text-green-500' : ''}`}>Newly Added</MenuItem>
								</MenuList>
							</Menu>
